...
const FooterNav = () => {
    ...
    return (
        <>
            ...
            <div className='bg-white shadow-md fixed bottom-0 md:bottom-6 md:-right-44 hover:-right-2 transition-all text-sm font-semibold border  w-full  md:w-48 justify-center items-center flex md:flex-col text-center h-[50px] md:h-auto'>
                <span className='inline-block left-[-24px] absolute h-12 w-12'>
